...
- A **self-growing competitor list**: a discovery agent finds new competitor stores via search dorks, stores them, and the competitor scraper picks them up automatically — the target list expands itself.
